...
type GreeterClient interface {
	GetStream(ctx context.Context, in *Request, opts ...grpc.CallOption) (Greeter_GetStreamClient, error)
...
func (c *greeterClient) GetStream(ctx context.Context, in *Request, opts ...grpc.CallOption) (Greeter_GetStreamClient, error) {
...
func (x *greeterGetStreamClient) Recv() (*Response, error) {
	m := new(Response)
...
func (x *greeterPutStreamClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterPutStreamClient) CloseAndRecv() (*Response, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Response)
...
func (x *greeterAllStreamClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterAllStreamClient) Recv() (*Response, error) {
	m := new(Response)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreeterServer interface {
	GetStream(*Request, Greeter_GetStreamServer) error
...
func (UnimplementedGreeterServer) GetStream(*Request, Greeter_GetStreamServer) error {
...
func (x *greeterGetStreamServer) Send(m *Response) error {
...
func (x *greeterPutStreamServer) SendAndClose(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterPutStreamServer) Recv() (*Request, error) {
	m := new(Request)
...
func (x *greeterAllStreamServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterAllStreamServer) Recv() (*Request, error) {
	m := new(Request)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
